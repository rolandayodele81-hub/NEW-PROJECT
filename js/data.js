...
(function(global){
  ...
  // Empty arrays will load from localStorage when available.
  // -----------------------------
  ...
  const departments = loadCollection('pdms-departments', [
  ...
  const users = loadCollection('pdms-users', [
  ...
  const consultants = loadCollection('pdms-consultants', [
  ...
  const clients = loadCollection('pdms-clients', [
  ...
  const projects = loadCollection('pdms-projects', [
  ...
  const activities = loadCollection('pdms-activities', [
