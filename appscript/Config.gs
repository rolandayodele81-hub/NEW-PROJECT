...
var ENTITIES = {
  ...
  projects: { sheet: 'Projects', idPrefix: 'PSE-', jsonFields: ['consultants', 'privateTasks', 'documents', 'milestones', 'subStatuses'], textFields: ['start', 'due', 'completion', 'actualCompletion'] },
