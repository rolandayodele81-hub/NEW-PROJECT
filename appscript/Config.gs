...
var ENTITIES = {
  ...
  clients: { sheet: 'Clients', idPrefix: 'CL', textFields: ['createdAt'] },
  projects: { sheet: 'Projects', idPrefix: 'PSE-', jsonFields: ['consultants', 'privateTasks', 'documents', 'milestones', 'subStatuses', 'timelineStages', 'timeline_stages'], textFields: ['start', 'due', 'completion', 'actualCompletion'] },
